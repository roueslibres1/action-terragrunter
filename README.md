  ...
  terragrunt:
    ...
    steps:
      ...
      - name: 'Terragrunt Format'
        uses: roueslibres1/action-terragrunter@master
        with:
...
2. Run it with:`test/local-test.sh <command>`
3. The above command:
